...
//echo'<input type="text" name="ans1" id="in_ans" class="qu_radio">'.$option.'<br><br>';
                    ...
                    echo '<br /><button type="submit" class="btn btn-primary" id="quiz_sub" ><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;Submit</button></form></div>';
//header("location:dash.php?q=4&step=2&eid=$id&n=$total");
                    ...
                    while ($row = mysqli_fetch_array($anstest)) {
                        ...
                        echo '<span style="background: linear-gradient(to bottom, #66ccff 0%, #ffff00 100%); font-size: 200%;" id="awnser_id">Awnser is : - ' . $awn . '</span>';
                    }
