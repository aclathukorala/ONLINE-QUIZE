...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>College</b></td><td><b>Score</b></td><td><b>Ranking</b></td></tr>';
            ...
            <?php if (@$_GET['q'] == 1) {
                ...
                echo '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Member</b></td><td><b>Institute</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
                $c = 1;
                while ($row = mysqli_fetch_array($result)) {
                    $name = $row['name'];
                   // $mob = $row['mob'];
                    ...
                    echo '<tr><td>' . $c++ . '</td><td>' . $name . '</td><td>' . $member . '</td><td>' . $college . '</td><td>' . $email . '</td>
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Question Details</b></span><br /><br />
 ...
 <form class="form-horizontal title1" name="form" action="update.php?q=addqns&n=' . @$_GET['n'] . '&eid=' . @$_GET['eid'] . '&ref=' . @$_GET['ref'] . '&ch=5 "  method="POST">
<fieldset>
';
