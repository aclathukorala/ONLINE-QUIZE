...
<!--            <div class="row">-->
                ...
                <div class="col-lg-2 col-md-offset-4">
                    <a href="feedback.php" target="_blank" class="btn btn-success">Feedback</a>
...
<div class="bg1">
    <div class="row">
        <div class="container">
            <div class="col-md-2">
                <img src="image/Torrent-Logos1.jpg" width="100" height="100">
            </div>
            <div class="col-md-2">
                <img src="image/Torrent-Logos3.jpg" width="100" height="100">
            </div>
            <div class="col-md-2">
                <img src="image/Torrent-Logos4.jpg" width="100" height="100">
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()"
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-md-12 control-label" for="name"></label>
                        <div class="col-md-12">
                            <input id="college" name="college" placeholder="Enter your Institute name"
