    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li <?php if (@$_GET['q'] == 6) echo 'class="active"'; ?>><a href="dash.php?q=6">Summary</a></li>
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Status</b></td><td></td></tr>';
                $c = 1;
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    if ($rowcount == 0) {
                        echo '<tr><td>' . $c++ . '</td><td>' . $title . '</td><td>' . $total . '</td><td>' . $sahi * $total . '</td><td>' . $st . '</td><td><button class="btn btn-warning admin_start_quz"><a href="dash.php?activate=1&eid=' . $eid . '" style="color: seashell"><b>ACTIVATE</b></a></button></td></tr>';
                    }
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td></td></tr>';
	...
	<td><b><a href="update.php?q=rmquiz&eid=' . $eid . '" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
            ...
            <?php if (@$_GET['q'] == 6) {
                ...
                $result = mysqli_query($con, "SELECT * FROM quiz ORDER BY date DESC") or die('Error');
                echo '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Questions</b></td><td><b>Submitted List</b></td><td></td></tr>';
                $c = 1;
                while ($row = mysqli_fetch_array($result)) {
                    $title = $row['title'];
                    $total = $row['total'];
                    ...
                    echo '<tr><td>' . $c++ . '</td><td>' . $title . '</td><td>' . $total . '</td><td>' . $sahi * $total . '</td><td><button class="btn btn-info"><a href="submitted_list.php" style="color:white"><b>View List</b></a></button></td></tr>';
                }
                $c = 0;
                echo '</table></div></div>';
            }
